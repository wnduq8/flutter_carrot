...
import 'package:carrot/repository/local_storage_repository.dart';
...
class ContentsRepository extends LocalStorageRepository {
  ...
  Future<List<Map<String, String>>> loadContentFromLocation(
  ...
  updateFavoriteContent(List<dynamic> favoriteContentList) async {
    await this
  ...
  addMyFavoriteContent(Map<String, dynamic>? content) async {
    ...
    if (!(favoriteContentList is List)) {
